    ...
    return (
        <div className="Footer">
            ...
            <div className="Footer__Socials"> 
                <a href="https://web.whatsapp.com/send?l=es&phone=573044837407"><img className="Footer__Whatsapp" src={Whatsapp} alt="Whatsapp"  /></a>
            ...
            <div className="Footer__Service">
                ...
                <a className="Footer__Links" href="https://web.whatsapp.com/send?l=es&phone=573044837407">&nbsp;CONTÁCTANOS<span className="Footer__Pipe">&nbsp;|</span></a>
