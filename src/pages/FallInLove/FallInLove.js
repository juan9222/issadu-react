...
export default function FallInLove() {
    return (
        <div className="FallInLove">
            ...
            en que cada prenda que compras ha sido 
            fabricada en Colombia bajo una profunda 
            convicción del crecimiento comunitario. 

            Tus vestidos de baño son confeccionados 
            por mujeres expertas y luchadoras que lideran 
