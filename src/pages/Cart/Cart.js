        ...
        <div className="Cart">
            ...
            <table className="Cart__Table">
                ...
                
                {
                    cart.map((cartElement,index)=>(
                        ...
                        <tr key={index}>
                            ...
                            <th>${new Intl.NumberFormat("es-ES").format(cartElement.priceDiscount)}</th>
                            <th>{cartElement.quantity}</th>
                            <th>${new Intl.NumberFormat("es-ES").format(cartElement.priceDiscount*cartElement.quantity)}</th>
                ...
                <tr className="Cart__Table-End">
                    ...
                    <th>${new Intl.NumberFormat("es-ES").format(cart.map(element => element.priceDiscount*element.quantity).reduce((prev, next) => prev + next, 0))}</th>
            ...
            <div className="CartMobile">
            {
                    cart.map((cartElement,index)=>(
                        ...
                        <div key={index}>
                            ...
                            <div className="CartMobile__Text">Precio: ${new Intl.NumberFormat("es-ES").format(cartElement.priceDiscount)}</div>
                            ...
                            <div className="CartMobile__Text">Valor Final: ${new Intl.NumberFormat("es-ES").format(cartElement.priceDiscount*cartElement.quantity)}</div>
                            <hr/>
                        </div>
                    ))
            }
            <div className="CartMobile__Text">Subtotal de la orden</div>
            <div className="CartMobile__Text">${new Intl.NumberFormat("es-ES").format(cart.map(element => element.priceDiscount*element.quantity).reduce((prev, next) => prev + next, 0))}</div>
